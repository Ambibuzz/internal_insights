...
class InsightsCustomDataSourceDocument:        
    def before_save(self: "InsightsCustomDataSource"):
...
class InsightsCustomDataSourceClient:
    @frappe.whitelist()
...
class InsightsCustomDataSource(InsightsCustomDataSourceDocument, InsightsCustomDataSourceClient, Document):
    @cached_property
